...
namespace BayesianClassifierApplication
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.initialiseClassifier = new System.Windows.Forms.Button();
            this.classifyDataSets = new System.Windows.Forms.Button();
            this.generatePerfromanceMeasures = new System.Windows.Forms.Button();
            ...
            // 
            this.initialiseClassifier.Enabled = false;
            this.initialiseClassifier.Location = new System.Drawing.Point(92, 26);
            this.initialiseClassifier.Name = "initialiseClassifier";
            this.initialiseClassifier.Size = new System.Drawing.Size(113, 23);
            this.initialiseClassifier.TabIndex = 5;
            this.initialiseClassifier.Text = "Initialise Classifier";
            this.initialiseClassifier.UseVisualStyleBackColor = true;
            this.initialiseClassifier.Click += new System.EventHandler(this.initialiseClassifier_Click);
            // 
            // classifyDataSets
            // 
            this.classifyDataSets.Enabled = false;
            this.classifyDataSets.Location = new System.Drawing.Point(211, 26);
            this.classifyDataSets.Name = "classifyDataSets";
            this.classifyDataSets.Size = new System.Drawing.Size(95, 23);
            this.classifyDataSets.TabIndex = 6;
            this.classifyDataSets.Text = "Classify datasets";
            this.classifyDataSets.UseVisualStyleBackColor = true;
            this.classifyDataSets.Click += new System.EventHandler(this.classifyDataSets_Click);
            // 
            // generatePerfromanceMeasures
            // 
            this.generatePerfromanceMeasures.Location = new System.Drawing.Point(312, 26);
            this.generatePerfromanceMeasures.Name = "generatePerfromanceMeasures";
            this.generatePerfromanceMeasures.Size = new System.Drawing.Size(178, 23);
            this.generatePerfromanceMeasures.TabIndex = 7;
            this.generatePerfromanceMeasures.Enabled = false;
            this.generatePerfromanceMeasures.Text = "Generate Performance Measures";
            this.generatePerfromanceMeasures.UseVisualStyleBackColor = true;
            this.generatePerfromanceMeasures.Click += new System.EventHandler(this.generatePerfromanceMeasures_Click);
            // 
            // MainForm
            // 
            ...
            this.Controls.Add(this.generatePerfromanceMeasures);
            this.Controls.Add(this.classifyDataSets);
            this.Controls.Add(this.initialiseClassifier);
        ...
        private System.Windows.Forms.Button initialiseClassifier;
        private System.Windows.Forms.Button classifyDataSets;
        private System.Windows.Forms.Button generatePerfromanceMeasures;
    }
}
